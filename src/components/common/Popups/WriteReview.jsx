...
const WriteReview = ({ selectedItemId, setSelectedItemId, setShowWriteReview }) => {
    ...
    const sendReviewButton = (e) => {
        e.preventDefault()
        api.writeReview(selectedItemId, name, body, like).then(review => {
                ...
                <div class="popup-content">
                    <div class="innter">
                        ...
                        <ul class="reactions">
                            <li>
                                {like === 1 ? (
                                    <img src={ImgReaction1} class="selected" onClick={() => setlike(1)} alt="" />
                                ) : (
                                    <img src={ImgReaction1} onClick={() => setlike(1)} alt="" />
                                )}
                            </li>
                            <li>
                                {like === 2 ? (
                                    <img src={ImgReaction2} class="selected" onClick={() => setlike(2)} alt="" />
                                ) : (
                                    <img src={ImgReaction2} onClick={() => setlike(2)} alt="" />
                                )}
                            </li>
                            <li>
                                {like === 3 ? (
                                    <img src={ImgReaction3} class="selected" onClick={() => setlike(3)} alt="" />
                                ) : (
                                    <img src={ImgReaction3} onClick={() => setlike(3)} alt="" />
                                )}
                            </li>
                            <li>
                                {like === 0 ? (
                                    <img src={ImgReaction0} class="selected" onClick={() => setlike(0)} alt="" />
                                ) : (
                                    <img src={ImgReaction0} onClick={() => setlike(0)} alt="" />
                                )}
                            </li>
                        </ul>
